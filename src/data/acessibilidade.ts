  ...
  [
    {
      ...
      texto: {
        pt: 'O axe-core corre sobre as sete rotas publicadas, nos dois temas, com a árvore fechada e aberta — vinte e oito combinações — antes de cada publicação, e bloqueia-a se encontrar alguma coisa. O contraste é calculado a partir dos tokens de cor, e a árvore inteira é aberta e fechada sem JavaScript.',
        en: 'axe-core runs over the seven published routes, in both themes, with the tree closed and open — twenty-eight combinations — before every release, and blocks it if anything turns up. Contrast is computed from the colour tokens, and the whole tree is opened and closed with JavaScript off.',
        fr: 'axe-core parcourt les sept routes publiées, dans les deux thèmes, l’arbre fermé puis ouvert — vingt-huit combinaisons — avant chaque publication, et la bloque au moindre problème. Le contraste est calculé à partir des jetons de couleur, et l’arbre entier s’ouvre et se ferme sans JavaScript.',
        es: 'axe-core recorre las siete rutas publicadas, en los dos temas, con el árbol cerrado y abierto — veintiocho combinaciones — antes de cada publicación, y la bloquea si encuentra algo. El contraste se calcula a partir de los tokens de color, y el árbol entero se abre y se cierra sin JavaScript.',
      },
    },
    {
      rotulo: { pt: 'o que se mediu à mão', en: 'measured by hand', fr: 'mesuré à la main', es: 'lo que se midió a mano' },
      texto: {
        pt: 'O que uma ferramenta não vê: refluxo a 320px sem barra horizontal, o espaçamento de texto da norma sem nada a cortar, todos os alvos pequenos com a folga de 24px que a norma pede, os cento e dez elementos focáveis alcançados por tabulação sem armadilha, e o anel de foco a 11:1 no tema claro e 8,9:1 no escuro.',
        en: 'What a tool cannot see: reflow at 320px with no horizontal bar, the standard’s text spacing with nothing clipped, every small target with the 24px separation the standard asks for, all one hundred and ten focusable elements reached by tabbing with no trap, and the focus ring at 11:1 in the light theme and 8.9:1 in the dark.',
        fr: 'Ce qu’un outil ne voit pas : la redistribution à 320px sans barre horizontale, l’espacement de texte de la norme sans rien de coupé, chaque petite cible avec l’écart de 24px exigé, les cent dix éléments focalisables atteints à la tabulation sans piège, et l’anneau de focus à 11:1 en thème clair et 8,9:1 en sombre.',
        es: 'Lo que una herramienta no ve: reflujo a 320px sin barra horizontal, el espaciado de texto de la norma sin nada cortado, cada objetivo pequeño con la holgura de 24px que la norma pide, los ciento diez elementos enfocables alcanzados por tabulación sin trampa, y el anillo de foco a 11:1 en el tema claro y 8,9:1 en el oscuro.',
      },
    },
    {
      rotulo: { pt: 'o que não cumpre', en: 'what does not conform', fr: 'ce qui n’est pas conforme', es: 'lo que no cumple' },
      texto: {
        pt: 'As gravações não têm transcrição (critério 1.2.1). São leituras de textos de outros autores, publicadas pelo esquerda.net, e cada entrada liga à página de origem; pôr aqui o texto integral era republicá-lo. Os dois vídeos não têm legendas nem descrição áudio (1.2.2, 1.2.3 e 1.2.5) — são filmes de promoção de vinte segundos, de outra casa, em que o que é meu é a voz.',
        en: 'The recordings have no transcript (criterion 1.2.1). They are readings of texts by other authors, published by esquerda.net, and every entry links to its source page; putting the full text here would be republishing it. The two films have no captions and no audio description (1.2.2, 1.2.3 and 1.2.5) — they are twenty-second promotional films, made by someone else, where what is mine is the voice.',
        fr: 'Les enregistrements n’ont pas de transcription (critère 1.2.1). Ce sont des lectures de textes d’autres auteurs, publiées par esquerda.net, et chaque entrée renvoie à sa page d’origine ; mettre ici le texte intégral reviendrait à le republier. Les deux vidéos n’ont ni sous-titres ni audiodescription (1.2.2, 1.2.3 et 1.2.5) — ce sont des films promotionnels de vingt secondes, d’une autre maison, où ce qui est de moi est la voix.',
        es: 'Las grabaciones no tienen transcripción (criterio 1.2.1). Son lecturas de textos de otros autores, publicadas por esquerda.net, y cada entrada enlaza a su página de origen; poner aquí el texto íntegro sería republicarlo. Los dos vídeos no tienen subtítulos ni descripción de audio (1.2.2, 1.2.3 y 1.2.5) — son películas de promoción de veinte segundos, de otra casa, en las que lo mío es la voz.',
      },
    },
    {
